...
export const NEWEST_MOVIES = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&sort_by=popularity.desc&primary_release_date.gte=`;
...
export const NEWEST_MOVIES_GER = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=de?sort_by=popularity.desc&primary_release_date.gte=`;
